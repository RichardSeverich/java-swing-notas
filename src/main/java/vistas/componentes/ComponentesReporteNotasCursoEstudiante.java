...
import vistas.ventanas.VentanaReporteNotasCursoEstudiante;

/**
* Class.
*/
public final class ComponentesReporteNotasCursoEstudiante {
  ...
  * Constructor.
  */
  private ComponentesReporteNotasCursoEstudiante() {
  }

  /**
   * @param ventana ventana.
  */
  public static void set(VentanaReporteNotasCursoEstudiante ventana) {
    panel = new JPanel();
    ...
    EventosReporteNotasCursoEstudiante eventosReporteNotasCursoEstudiante = new EventosReporteNotasCursoEstudiante();
    table = new JTable();
    table.addMouseListener(eventosReporteNotasCursoEstudiante);
