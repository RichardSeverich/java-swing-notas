...
import vistas.eventos.EventosInscripcionMostrarCurso;
import vistas.ventanas.VentanaInscripcionMostrarCurso;

/**
* Class.
*/
public final class ComponentesInscripcionMostrarCurso {
  ...
  * Constructor.
  */
  private ComponentesInscripcionMostrarCurso() {
  }

  /**
   * @param ventana ventana.
  */
  public static void set(VentanaInscripcionMostrarCurso ventana) {
    ...
    EventosInscripcionMostrarCurso eventosInscripcionMostrarCurso = new EventosInscripcionMostrarCurso();
    table = new JTable();
    table.addMouseListener(eventosInscripcionMostrarCurso);
