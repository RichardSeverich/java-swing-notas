...
import vistas.eventos.EventosReporteNotasCursoEstudiante;
import vistas.utiles.Render;
import vistas.ventanas.VentanaReporteNotasCursoMateria;

/**
* Class.
*/
public final class ComponentesReporteNotasCursoMateria {
  ...
  * Constructor.
  */
  private ComponentesReporteNotasCursoMateria() {
  }

  /**
   * @param ventana ventana.
  */
  public static void set(VentanaReporteNotasCursoMateria ventana) {
    panel = new JPanel();
  ...
  */
  public static void actualizarTabla() {
    String title = "Materias del Curso " + ComponentesReporteNotasCursoEstudiante.course.nombre
        + " Estudiante " + EventosReporteNotasCursoEstudiante.estudiante.nombres
        + " " + EventosReporteNotasCursoEstudiante.estudiante.apellidos;
  ...
  */
  private static Object[][] construtirDatos() {
    Curso curso = ComponentesReporteNotasCursoEstudiante.course;
    Estudiante estudiante = EventosReporteNotasCursoEstudiante.estudiante;
