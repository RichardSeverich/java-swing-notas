...
import vistas.eventos.EventosNotasRegistrarCurso;
import vistas.ventanas.VentanaNotasRegistrarCurso;

/**
* Class.
*/
public final class ComponentesNotasRegistrarCurso {
  ...
  * Constructor.
  */
  private ComponentesNotasRegistrarCurso() {
  }

  /**
   * @param ventana ventana.
  */
  public static void set(VentanaNotasRegistrarCurso ventana) {
    ...
    EventosNotasRegistrarCurso eventosNotasRegistrarCurso = new EventosNotasRegistrarCurso();
    table = new JTable();
    table.addMouseListener(eventosNotasRegistrarCurso);
