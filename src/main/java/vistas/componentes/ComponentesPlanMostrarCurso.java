...
import vistas.eventos.EventosPlanMostrarCurso;
import vistas.ventanas.VentanaPlanMostrarCurso;

/**
* Class.
*/
public final class ComponentesPlanMostrarCurso {
  ...
  * Constructor.
  */
  private ComponentesPlanMostrarCurso() {
  }

  /**
   * @param ventana ventana.
  */
  public static void set(VentanaPlanMostrarCurso ventana) {
    ...
    EventosPlanMostrarCurso eventosPlanMostrarCurso = new EventosPlanMostrarCurso();
    table = new JTable();
    table.addMouseListener(eventosPlanMostrarCurso);
