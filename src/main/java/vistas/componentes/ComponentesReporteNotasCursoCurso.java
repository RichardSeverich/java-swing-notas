...
import vistas.eventos.EventosReporteNotasCursoCurso;
import vistas.ventanas.VentanaReporteNotasCursoCurso;

/**
* Class.
*/
public final class ComponentesReporteNotasCursoCurso {
  ...
  * Constructor.
  */
  private ComponentesReporteNotasCursoCurso() {
  }

  /**
   * @param ventana ventana.
  */
  public static void set(VentanaReporteNotasCursoCurso ventana) {
    ...
    EventosReporteNotasCursoCurso eventosReporteNotasCursoCurso = new EventosReporteNotasCursoCurso();
    table = new JTable();
    table.addMouseListener(eventosReporteNotasCursoCurso);
